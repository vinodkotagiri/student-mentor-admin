...
const EditStudent = () => {
    ...
    console.log(id)
    console.log(student)
    const [firstName, setFName] = useState(student[id].firstName)
    const [lastName, setLName] = useState(student[id].lastName)
    const [mobile, setMobile] = useState(student[id].mobile)
    const [email, setEmail] = useState(student[id].email)
